    ...
    class upload
    {
        ...
        public static void suploader()
        {
            try
            {
                ...
                {
                    Console.WriteLine("Autologin ist derzeit nicht verfügbar!");
                    klassen.logger.__logger("\t1", "AUTOLOGIN ist dezeit nicht verfügbar...");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        long n_groesse = groesse / 1024 / 1024;

                        klassen.logger.__logger("\t1\t", name + " ( " + n_groesse + "MB ) wurde erfolgreich hochgeladen!");
                        ...
                        if (ftprespone.StatusCode == FtpStatusCode.FileActionAborted)
                        {
                            ...
                            Console.WriteLine(@"%APPDATA%\sharploader\error.log oder fragen Sie ihren Systemadministrator!");
        ...
        public static void uploader()
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("If your FTP Server supports TLS / SSL please use: sup() instead!");
                Console.ResetColor();


                watch05.Start();

                if (!File.Exists(klassen.filesystem.appdata + @"\sharploader\autologin.login"))
                {
                ...
                else
                {
                    ...
                    Console.WriteLine(@"Bitte löschen Sie unter %APPDATA%\sharploader die autologin.login!");
                    Console.ReadLine();
